...
public class Elevator extends CommandBase
{
    ...
    public Elevator(double setpointDistance,double epsilonDistance)
    {
        this.setpointDistance = setpointDistance;
        addRequirements(drive);

        pidYAxis = new PIDController(0.04, 0, 0);
    ...
    public void execute()
    {
        ...
        drive.setElevatorSpeed(
         MathUtil.clamp(pidYAxis.calculate(drive.getLiftEncoderDistance(), setpointDistance), -0.3, 0.3));
        } else {
